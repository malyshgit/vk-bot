...
public class Ads extends AbstractAction {
     ...
     * @param data Serialized JSON array of commands that describe added managers. Description of 'user_specification' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe created ads. Description of 'ad_specification' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe created campaigns. Description of 'campaign_specification' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe created campaigns. Description of 'client_specification' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param idsType Type of requested commands listed in 'ids' parameter: *ad — ads,, *campaign — campaigns.
     * @param ids IDs requested ads or campaigns, separated with a comma, depending on the value set in 'ids_type'. Maximum 2000 commands.
     ...
     * @param accountId Advertising account ID.
     * @param idsType Type of requested commands listed in 'ids' parameter: *ad — ads,, *campaign — campaigns.
     * @param ids IDs requested ads or campaigns, separated with a comma, depending on the value set in 'ids_type'. Maximum 100 commands.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param idsType Type of requested commands listed in 'ids' parameter: *ad — ads,, *campaign — campaigns,, *client — clients,, *office — account.
     * @param ids IDs requested ads, campaigns, clients or account, separated with a comma, depending on the value set in 'ids_type'. Maximum 2000 commands.
     * @param period Data grouping by dates: *day — statistics by days,, *month — statistics by months,, *overall — overall statistics. 'date_from' and 'date_to' parameters set temporary limits.
     * @param dateFrom Date to show statistics from. For different value of 'period' different date format is used: *day: YYYY-MM-DD, example: 2011-09-27 — September 27, 2011, **0 — day it was created on,, *month: YYYY-MM, example: 2011-09 — September 2011, **0 — month it was created in,, *overall: 0.
     * @param dateTo Date to show statistics to. For different value of 'period' different date format is used: *day: YYYY-MM-DD, example: 2011-09-27 — September 27, 2011, **0 — current day,, *month: YYYY-MM, example: 2011-09 — September 2011, **0 — current month,, *overall: 0.
     * @return query
     ...
     * @param cities IDs of cities where commands are searched in, separated with a comma.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe changes in ads. Description of 'ad_edit_specification' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe changes in campaigns. Description of 'campaign_mod' commands see below.
     * @return query
     */
     ...
     * @param actor vk actor
     * @param accountId Advertising account ID.
     * @param data Serialized JSON array of commands that describe changes in clients. Description of 'client_mod' commands see below.
     * @return query
     */
