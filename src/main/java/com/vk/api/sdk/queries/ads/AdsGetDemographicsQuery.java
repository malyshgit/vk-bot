...
public class AdsGetDemographicsQuery extends AbstractQueryBuilder<AdsGetDemographicsQuery, List<DemoStats>> {
    ...
    /**
     * Type of requested commands listed in 'ids' parameter: *ad — ads,, *campaign — campaigns.
     *
    ...
    /**
     * IDs requested ads or campaigns, separated with a comma, depending on the value set in 'ids_type'. Maximum 2000 commands.
     *
