...
public class AdsGetStatisticsQuery extends AbstractQueryBuilder<AdsGetStatisticsQuery, List<Stats>> {
    ...
    /**
     * Type of requested commands listed in 'ids' parameter: *ad — ads,, *campaign — campaigns,, *client — clients,, *office — account.
     *
    ...
    /**
     * IDs requested ads, campaigns, clients or account, separated with a comma, depending on the value set in 'ids_type'. Maximum 2000 commands.
     *
