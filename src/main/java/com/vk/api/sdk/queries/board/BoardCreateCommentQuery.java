...
public class BoardCreateCommentQuery extends AbstractQueryBuilder<BoardCreateCommentQuery, Integer> {
    ...
    /**
     * attachments
     * (Required if 'text' is not set.) List of media commands attached to the comment, in the following format: "<owner_id>_<media_id>,<owner_id>_<media_id>", ' — Type of media object: 'photo' — photo, 'video' — video, 'audio' — audio, 'doc' — document, '<owner_id>' — ID of the media owner. '<media_id>' — Media ID.
     *
